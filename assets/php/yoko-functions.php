...
function yoko_scripts() {
  ...
  wp_enqueue_style('theme-style', get_stylesheet_uri(), array(), '2014-03-18');
...
function yoko() {
  ...
  define( 'HEADER_IMAGE', '%s/assets/images/headers/ginko.jpg' );
  ...
  register_default_headers( array(
      'ginko' => array(
      'url' => '%s/assets/images/headers/ginko.jpg',
      'thumbnail_url' => '%s/assets/images/headers/ginko-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Ginko', 'yoko' )
      ),
      'flowers' => array(
      'url' => '%s/assets/images/headers/flowers.jpg',
      'thumbnail_url' => '%s/assets/images/headers/flowers-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Flowers', 'yoko' )
      ),
      'plant' => array(
      'url' => '%s/assets/images/headers/plant.jpg',
      'thumbnail_url' => '%s/assets/images/headers/plant-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Plant', 'yoko' )
      ),
      'sailing' => array(
      'url' => '%s/assets/images/headers/sailing.jpg',
      'thumbnail_url' => '%s/assets/images/headers/sailing-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Sailing', 'yoko' )
      ),
      'cape' => array(
      'url' => '%s/assets/images/headers/cape.jpg',
      'thumbnail_url' => '%s/assets/images/headers/cape-thumbnail.jpg',
      /* translators: header image description */
      'description' => __( 'Cape', 'yoko' )
      ),
      'seagull' => array(
      'url' => '%s/assets/images/headers/seagull.jpg',
      'thumbnail_url' => '%s/assets/images/headers/seagull-thumbnail.jpg',
      /* translators: header image description */
...
function yoko_comment( $comment, $args, $depth ) {
  ...
  <li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <?php printf( __( '%s', 'yoko' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
